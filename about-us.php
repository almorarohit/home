...
<div class="container" style="margin-top:50px;">
		<div style="text-align:center;" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             <h2>ABOUT US</h2>
				...
				items dal and chawal. We at Sastachawal ensure that our customers get

				best quality products at lowest prices in the market. Our team strive

				hard each and every day to provide our customers with quality services

				and products at best possible prices, thereby making shopping with
				...
				and satisfied with us. Leave a message for us…
				</p>
        </div>
    </div>
